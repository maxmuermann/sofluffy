...
- Material-based shell generation, no geometry is duplicated. SO FLUFFY use a cascade of netx_pass materials for subsequent shells and performs all geomerty operations in its vertex shader
